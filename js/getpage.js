...
'</button>',
    ...
    '    <img src="./images/loading.svg" style="width: 100%;height: 250px;">'+
    '</div>',
    'cart':'',
    'sushi':'<div class = "goods" id="goodsField"><img src="./images/loading.svg" style="width: 100%;height: 250px;"></div>',
    'pizza':'<div class = "goods" id="goodsField"><img src="./images/loading.svg" style="width: 100%;height: 250px;"></div>',
    'drinks':'<div class = "goods" id="goodsField"><img src="./images/loading.svg" style="width: 100%;height: 250px;"></div>',
    'all':'<span><h1 style="margin-left:10px;margin-top: 0px;">Pizzas</h1></span>'+
          '<div class = "goods" id="PizzaField"><img src="./images/loading.svg" style="width: 100%;height: 250px;"></div>'+
          '<span><h1 style="margin-left:10px;margin-top: 0px;">Sushies</h1></span>'+
          '<div class = "goods" id="SushiField"><img src="./images/loading.svg" style="width: 100%;height: 250px;"></div>'+
          '<span><h1 style="margin-left:10px;margin-top: 0px;">Drinks</h1></span>'+
          '<div class = "goods" id="DrinksField"><img src="./images/loading.svg" style="width: 100%;height: 250px;"></div>'
};
